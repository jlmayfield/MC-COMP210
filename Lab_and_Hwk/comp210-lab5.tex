...
Work towards implementing the core functionality for the puzzle problem that we worked out in class Wednesday. Focus your efforts on the low-level, list-based Group implementation. If you get that complete, then take a crack at the ArrayGroup implementation\sidenote{\url{https://docs.oracle.com/javase/tutorial/java/nutsandbolts/arrays.html}}. 
